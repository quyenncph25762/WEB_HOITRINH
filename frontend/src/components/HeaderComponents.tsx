...
const HeaderComponents = () => {
  return (
    <header className='sticky top-0 z-30 w-full px-2 py-2 bg-white sm:px-4 shadow-xl'>
      <div className='flex flex-wrap items-center gap-5 w-full  container'>
        <Link href={"/"}><img src="https://i.pinimg.com/564x/1f/ce/4d/1fce4d65417a3acce9a5f67b2902ff99.jpg" alt="logo" className='w-36' />
        </Link>
        <div id="collapseMenu"
          ...
          <ul
            ...
            <li className='max-lg:border-b max-lg:py-3 px-3'><Link href={`/products`}
              className='lg:hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'>Cửa hàng</Link>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'><Link href={`/introduce`}
              className='lg:hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'>Giới thiệu</Link>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'><Link href={`/service`}
              className='lg:hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'>Dịch vụ</Link>
            </li>

            <li className='max-lg:border-b max-lg:py-3 px-3'><Link href={`/contact`}
              className='lg:hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'>Liên hệ</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="flex text-[#777]">
          ...
          <div className="ml-2">
            ...
            <Link className='ml-1' href={"/signup"}>Đăng kí</Link>
          </div>
        </div>
      </div>
    </header>
